...
goog.provide('Blockly.JavaScript.jellypi');

goog.require('Blockly.JavaScript');


Blockly.JavaScript['jellypi_input_port'] = function(block) { //digital pin number
...
Blockly.JavaScript['jellypi_output_port'] = function(block) { //digital pin number
    var pin = block.getFieldValue('pin');
...
Blockly.JavaScript['jellypi_i2c_port'] = function(block) { //digital pin number
    var pin = block.getFieldValue('pin');
